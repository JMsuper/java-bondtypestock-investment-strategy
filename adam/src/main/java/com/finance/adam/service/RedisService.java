...
public class RedisService {
    ...
    public Object getData(String key) {
        log.debug("Getting data from Redis - key: {}", key);
    ...
    public boolean isKeyExists(String key) {
        log.debug("Checking if key exists in Redis - key: {}", key);
    ...
    public void pushToList(String key, Object value) {
        log.debug("Pushing data to Redis list - key: {}", key);
    ...
    public void trimList(String key, int start, int end) {
        log.debug("Trimming Redis list - key: {}, start: {}, end: {}", key, start, end);
    ...
    public List<Object> getListRange(String key, int start, int end) {
        log.debug("Getting range from Redis list - key: {}, start: {}, end: {}", key, start, end);
    ...
    public void deleteKey(String key) {
        log.debug("Deleting key from Redis - key: {}", key);
